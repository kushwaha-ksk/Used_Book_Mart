      ...
      <div className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
         ...
         <div className='flex flex-[2] flex-col gap-3' >
           ...
           {books.map((book)=>{
            ...
            if(quantity > 0){
              return(
                <div key={book._id} className='grid grid-cols-[6fr_1fr_2fr] text-base font-medium bg-primary p-2 rounded-lg'>
                 ...
                 <p className='pt-6 pl-4'>{currency}{book.price * quantity}</p>
