  ...
  return (
    <section className='max-padd-container py-8 mt-2'>
        <div className='flexBetween flex-wrap gap-7'>
          <div>
            <h4 className='bold-14 uppercase tracking-wider'>Subscribe newsletteer</h4>
            <p>Get latest information on Events, Sales & offers.</p>
          </div>
          <div>
            <div className='flex bg-primary'>
              <input type='email' placeholder='Email Address' className='p-3 bg-primary w-[222px] sm:w-[266px] outline-none text-[13px]' />
